    ...
    def assign_label(self):
        ...
        for i in range(len(self.My_Data_All)):
            ...
            for j in range(self.cluster_number):
                distance.append(math.sqrt(((self.centroid_points[j].coordinate[0])-self.My_Data_All[i].coordinate[0])**2+((self.centroid_points[j].coordinate[0])-self.My_Data_All[i].coordinate[1])**2))
